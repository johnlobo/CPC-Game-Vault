...
export default function GameNotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      <AlertTriangle className="w-16 h-16 text-destructive mb-4" /> {/* Adjusted size */}
      <h1 className="text-xl sm:text-2xl font-bold text-primary mb-2">Game Not Found</h1> {/* Adjusted size */}
      ...
      <Button asChild size="sm" className="text-xs"> {/* Adjusted size & text size */}
