  ...
  return (
    <div className="space-y-8">
      <section className="text-center py-8 rounded-lg bg-card shadow-md">
        <h1 className="text-xl sm:text-2xl font-extrabold mb-4 text-primary tracking-tight">
      ...
      {gamesToDisplay.length > 0 ? (
        ...
        <p className="text-center text-muted-foreground py-10 text-sm">No games available at the moment. Check back soon!</p>
      )}
       {allGames.length > 4 && (
