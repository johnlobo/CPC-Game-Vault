...
import { PlusCircle, Edit, Trash2, Settings, Library } from 'lucide-react';
...
const gameFormSchema = z.object({
  id: z.string().min(1, "ID is required."), // Simplified schema
  ...
  return (
    <div className="space-y-4 sm:space-y-5">
      ...
      <div className="bg-card p-3 sm:p-4 rounded-lg shadow-xl">
        <h2 className="text-2xl sm:text-3xl font-bold text-accent mb-3 tracking-tight">
          Game Management
        </h2>
                ...
                {games.map((game) => (
                  <TableRow key={game.id}>
                    ...
                    <TableCell className="text-right space-x-1">
                      ...
                      <Button variant="destructive" size="sm" className="text-sm" disabled> {/* Delete is still disabled */}
